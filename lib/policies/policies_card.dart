...
class PoliciesPortion extends StatelessWidget {
  const PoliciesPortion({Key? key}) : super(key: key);
    ...
    return Wrap(
      children: [
        policy(
            name: "About Us",
            text:
                '''Welcome to Advaita Unnati OPC Pvt., Ltd.  We are one of the great best sellers in market to provide and give you the products and items at the cheapest price with good quality; we are near to you with our web portal and mobile platform to serve you.'''),
        policy(name: "Contact Us", text: '''9885139139.whats app
8142162888.whats app

Registered Office :

ADVAITA UNNATI OPC PVT LTD.,
68-5-1 , LAXMI PLAZA ,
RAMALAYAM STREET ,
VIJAYAWADA-520010.
advaitaunnatti@gmai.com'''),
        policy(
...
As a minor if you wish to transact on the Platform, such transaction on the Platform may be made by your legal guardian or parents. Advaita reserves the right to terminate your membership and / or refuse to provide you with access to the Platform if it is brought to Advaita's notice or if it is discovered that You are under the age of 18 years and transacting on the Platform.
'''),
        policy(
            name: "Your Account and Registration Obligations",
            text:
...
You agree that Advaita shall not be liable or responsible for the activities or consequences of use or misuse of any information that occurs under your Account in cases, including, where You have failed to update Your revised mobile phone number and/or e-mail address on the Website Platform.
...
'''),
        policy(
            ...
            text:
                '''1.	The products and Items in our website are based on availability of stock. 
2.	This Offer is being run by Advaita Unnati OPC Pvt., Ltd. on its Platform.
3.	Customers are not bound in any way to participate in this Offer. Any participation is voluntary, and the Offer is being made purely on a best effort basis.
4.	Advaita, in its sole discretion, reserves the right to disqualify You from the Offer and/or the benefits of this Offer, if any fraudulent activity is identified as being carried out for the purpose of availing the benefits under the said Offer.
5.	The Offer shall be subject to force majeure events and on occurrence of such an event, the Offer may be withdrawn at the discretion of the Brand and/or Advaita.
6.	Advaita shall not be responsible for any loss, injury or any other liability arising due to participation by any person in this Offer.
7.	Advaita does not endorse the products sold on the Platform and will not accept any liability pertaining to the quality, merchantability, fitness, delivery or after sales service of Product(s). Advaita shall not be responsible towards any delay or failure of delivery of the Product to any Customer(s) during the provided timeline.
8.	Customer understands that Advaita shall not be liable towards the quality of the Product and/or fulfillment of the Productand/or warranty claims and/or after sales services of the Product(s) and/or taxes arising out of the same. Any claim or dispute in relation to the same must be directed towards Brand/Sellers only.
9.	Customer hereby agree to abide by the terms and conditions and privacy policy and other documents as may be applicable to him/her while accessing the Platform also to indemnify and keep Advaita harmless against all damages, liabilities, costs, expenses, claims, suits and proceedings (including reasonable attorney’s fee) that may be suffered by Advaita as a consequence of (i) violation of terms of this T&C and other terms of the Platform by Customer; (ii) violation of applicable laws; (iii) any action or inaction resulting in wilful misconduct or negligence on Customer’s part.
10.	Customers hereby agree that Advaita has the sole right to decide all matters and disputes arising from this Offer and that all decisions of Advaita and/or Seller are final and binding.
11.	Advaita reserves the right to amend, modify, cancel, update or withdraw this Offer at any time without notice. Upon such premature suspension, inconvenience, cessation, withdrawal, termination or closure of the Offer by Advaita no person shall be entitled to claim loss of any kind whatsoever.
12.	This T&C shall be governed in accordance with the applicable laws in India. Courts at Vijayawada shall have the exclusive jurisdiction to settle any dispute that may arise under this T&C.
13.	Advaita will not entertain any correspondence or communication regarding this Offer from any customer/persons.
14.	The Offer shall be subject to the Income-Tax Act, 1961 and all disbursements shall be subject to TDS, as applicable.
15.	This document is an electronic record in terms of Information Technology Act, 2000, and the Rules thereunder as applicable and the amended provisions pertaining to electronic records in various statutes as amended by the Information Technology Act, 2000. This electronic record is generated by a computer system and does not require any physical or digital signatures.
'''),
        policy(name: "Privacy and Policies", text: "Loading..."),
        policy(
...
(o) engages in commercial activities and/or sales without Our prior written consent such as contests, sweepstakes, barter, advertising and pyramid schemes, or the buying or selling of "virtual" products related to the Platform. Throughout this Terms of Use, Advaita's prior written consent means a communication coming from Advaita's Legal Department, specifically in response to Your request, and specifically addressing the activity or conduct for which You seek authorization;
...
7.	You may not use the Platform or any content for any purpose that is unlawful or prohibited by these Terms of Use, or to solicit the performance of any illegal activity or other activity which infringes the rights of Advaita and / or others.
...
3.	Advaita shall have all the rights to take necessary action and claim damages that may occur due to your involvement/participation in any way on your own or through group/s of people, intentionally or unintentionally in DoS/DDoS (Distributed Denial of Services).
4.	If you choose to browse or transact on the Platform using the voice command-based shopping
feature, you acknowledge that Advaita and/or its affiliates will collect, store and use your voice inputs on this feature to customize your experience and provide additional functionality as well as to improve Advaita’s and/or its affiliates’ products and services. Advaita’s and/or its affiliates’ use of your voice data will be in accordance with the Advaita Privacy Policy. You accept that your use of this feature is restricted to the territory of the Republic of India. This feature may not be accessible on certain devices and requires an internet connection. Advaita reserves the right to change, enhance, suspend, or discontinue this feature, or any part of it, at any time without notice to you. Your continued use of this feature constitutes your acceptance of the terms related to this feature.
5.	You acknowledge and agree that the Hindi, Telugu, Tamil, Kannada and Marathi, Bengali, Gujarati , Odia, Malayalam, Punjabi & Assamese translation features are made available on the Platform on a reasonable effort basis for convenience only, without any representation or warranties by Advaita, express or implied, including the translations being error free, their accuracy, completeness or reliability. Under the translation feature, You will have the option to adding delivery addresses in the language selected by You out of the featured languages. Such delivery addresses shall be transliterated in English language for processing, handling and fulfilling Your orders on the Platform. Advaita expressly disclaims any liability of any nature whatsoever arising from or related to the said translation/transliteration features on the Platform. Some features and sections on the Platform may not be translated in the language selected by You [Hindi, Telugu, Tamil, Kannada, Marathi, Bengali, Gujarati, Odia, Malayalam, Punjabi & Assamese language, as applicable], and the English version of the same will be the definitive version. In the event of any conflict or inconsistency between the translated terms and the English version available on the Platform, the English version on the Platform shall prevail. This feature may not be accessible on certain devices. Advaita reserves the right to change, enhance, suspend, or discontinue this feature, or any part of it, at any time without notice to You.
'''),
      ],
    );
  }
...
class PolicyScreen extends StatelessWidget {
  final String name;
  final String text;
  const PolicyScreen(this.name, this.text, {Key? key}) : super(key: key);
